      ...
      <div style={{
        ...
        {showBtn && (
          <button
            ...
            onMouseEnter={e  => { e.currentTarget.style.background = '#d0dde8'; }}
            onMouseLeave={e  => { e.currentTarget.style.background = '#E8F0F8'; e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '0 5px 0 rgba(0,0,0,0.5)'; }}
            onMouseDown={e   => { e.currentTarget.style.transform = 'translateY(4px)'; e.currentTarget.style.boxShadow = '0 1px 0 rgba(0,0,0,0.5)'; }}
            onMouseUp={e     => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '0 5px 0 rgba(0,0,0,0.5)'; }}
          >
            推门进入 →
          </button>
        )}
